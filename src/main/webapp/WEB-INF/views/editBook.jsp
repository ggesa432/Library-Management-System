                ...
                <div class="form-group">
                    ...
                    <div class="card bg-light">
                        <div class="card-body py-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="mb-0"><strong>Status:</strong> <span id="statusLabel" class="badge"></span></p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-0"><strong>Available Copies:</strong> <span id="availableCopies"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $.ajax({
            ...
            success: function(book) {
                ...
                $('#statusLabel')
                    .text(book.status)
                    .removeClass()
                    .addClass('badge ' + (book.status === 'Available' ? 'badge-success' : 'badge-danger'));
