...
<div class="container mt-4">
    <div class="row mb-3">
        ...
        <div class="col-md-6 text-right">
            <button type="button" class="btn btn-success" onclick="window.location.href='${pageContext.request.contextPath}/members/add'">
        ...
        <div class="card-header bg-light">
            <form id="searchForm" class="form-inline">
                <div class="form-group mr-2 flex-grow-1">
                    <input type="text" class="form-control w-100" id="searchTerm" name="searchTerm" placeholder="Search by name, email, phone...">
                </div>
...
<script>
    ...
    function searchMembers() {
        ...
        $.ajax({
            url: '${pageContext.request.contextPath}/api/members/search?query=' + encodeURIComponent(searchTerm),
            type: 'GET',
            success: function(members) {
                updateMembersTable(members);
            },
            error: function(xhr, status, error) {
                ...
                alert('Failed to search members. Please try again later.');
            }
        });
    }
    ...
    function updateMembersTable(members) {
        ...
        if (members.length === 0) {
            tableBody.append('<tr><td colspan="7" class="text-center">No members found</td></tr>');
            return;
        }
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                <button type="button" class="btn btn-info" onclick="viewMember(\${member.memberId})">
                                    <i class="fas fa-eye"></i>
                                </button>
                                <button type="button" class="btn btn-warning" onclick="editMember(\${member.memberId})">
                                    <i class="fas fa-edit"></i>
                                </button>
                                <button type="button" class="btn btn-danger" onclick="deleteMember(\${member.memberId})">
